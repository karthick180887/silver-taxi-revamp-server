...
export default function RoundTripServicePage() {
    ...
    const fetchServiceConfig = async () => {
        try {
            const response = await axios.get(`${API_URL}/v1/services/round-trip`, {
    ...
    const handleServiceToggle = async (enabled: boolean) => {
        ...
        try {
            await axios.put(`${API_URL}/v1/services/round-trip`, { enabled }, {
                headers: { Authorization: `Bearer ${localStorage.getItem('admin_token')}` },
            });
        } catch (error) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <Typography variant="h4" className="font-bold">Outstation - Round Trip</Typography>
            </div>
            ...
            <Paper className="p-6 space-y-6">
                ...
                <div>
                    <Typography variant="h6" className="font-bold mb-4">Round Trip Vehicle</Typography>

...
class VendorApiClient extends BaseApiClient {
  ...
  /// GET /vendor/bookings
  Future<ApiResult> getAllBookings({required String token}) {
    return get('/vendor/bookings', token: token);
  }
  ...
  Future<ApiResult> getSpecificBookings({
    ...
    return get('/vendor/bookings/specific', token: token, queryParams: queryParams);
  }

  /// GET /vendor/bookings/counts
  Future<ApiResult> getBookingCounts({required String token}) {
    return get('/vendor/bookings/counts', token: token);
  }

  /// GET /vendor/bookings/drivers
  Future<ApiResult> getDrivers({required String token}) {
    return get('/vendor/bookings/drivers', token: token);
  }
